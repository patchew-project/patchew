...
def tags_to_property(apps, schema_editor):
    ...
    for m in messages:
        mp = MessageProperty(message=m, name="tags", value=m.tags, blob=False)
        mp.save()


class Migration(migrations.Migration):

    dependencies = [("api", "0035_message_tags")]

    operations = [
        migrations.RunPython(tags_from_property, reverse_code=tags_to_property)
    ]
